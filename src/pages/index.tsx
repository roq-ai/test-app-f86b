  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock the power of data with Test App - your ultimate solution for collecting, managing, and leveraging exam information and beyond."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1480694313141-fce5e697ee25?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhcHB8ZW58MHx8fHwxNjkwODE1NTMxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@rami_alzayat?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Rami Al-zayat`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock the power of data with Test App - your ultimate solution for collecting, managing, and leveraging exam information and beyond.`}
            </Text>
            <Box
